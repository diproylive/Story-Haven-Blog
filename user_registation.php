                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="user_registation.php" class="">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingText" name="username" placeholder="name123" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="file" class="form-control" id="floatingText" name="user_photo" placeholder="profile Image">
                            <label for="floatingText">Select Profile Photo</label>
                        </div>
                        ...
                        <p class="text-center mb-0">Already have an Account? <a href="user_login.php">Sign In</a></p>
                        </form>
                    </div>
                </div>
            </div>
            ...
            if (in_array($img_extention, $allow_type)){
                if ($file_size <= 8000000){
                    if (move_uploaded_file($tmp_name, $dest)) {
                        $sql2 = "INSERT INTO `users`(`user_name`, `user_full_name`, `user_email`, `user_password`, `user_cpassword`, `user_photo`) VALUES ('$username','$name','$email','$password','$cpassword','$file_name')";
