                ...
                <div class="container bootstrap snippets bootdey mt-10">
                    <div class="cover-container mt-10">
                        ...
                        <div class="social-avatar" >
                            <img class="img-avatar" src="../img/<?php if(isset($_SESSION['user_data'])){ echo $_SESSION['user_data']['8'];}?>" height="100" width="100">
                            <h4 class="fg-white text-center"><?php if(isset($_SESSION['user_data'])){ echo $_SESSION['user_data']['2'];}?></h4>
                            <h6 class="fg-white text-center" style="opacity:0.8;"><?php if(isset($_SESSION['user_data'])){ echo $_SESSION['user_data']['9'];}?></h6>
                        ...
                        while($row2 = mysqli_fetch_array($result2)){?>
                            ...
                            <div class="card" style="width: 18rem;">
                              ...
                              <div class="card-body">
                                ...
                                <a href="edit_post.php?Edit_id=<?php echo $row2['blog_id'];?>" class="btn mr-2"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                <a href="delete_post.php?Deleted_id=<?php echo $row2['blog_id'];?>" class="btn mr-2" id="Deleted"><i class="fa fa-trash"></i> Delete</a>
