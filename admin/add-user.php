...
<head>
    <meta charset="utf-8">
    <title>Admin DashBoard || User Element</title>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="add-user.php" class="dropdown-item active">Modify Users</a>
                            <a href="element.html" class="dropdown-item">Other Elements</a>
                        </div>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-sm btn-danger text-white">
                                                                <a href ="delete_user.php?Deleted_id=<?php echo $row['user_id'];?>" title="Delete <?php echo $row['user_name'];?>" class="text-white">Delete</a>
                                                            </button>
                                                        </td>
                                                    </tr>
