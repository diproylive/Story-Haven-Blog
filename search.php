...
<head>
    <meta charset="utf-8">
    <title>Blog || Search Keywords</title>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">  
                  <div class="container mx-auto mt-4">
                    <div class="bg-secondary rounded h-1 p-4">
                        <hr>
                        <a href = "index.php" ><h5 class=" mt-4 btn text-success">Back</h5></a>
                        <h3 class="text-center">Search Result For : " <span class="text-primary"><?= $keywords?></span> "</h3>
                        <hr>
                    </div>
                    <div class="row">
                        ...
                        while($row2 = mysqli_fetch_assoc($result2))
                        {
                            ...
                            <div class="card" style="width: 18rem;">
                              ...
                              <div class="card-body">
                                ...
                                <p class="card-text"><?php echo strip_tags(substr($row2['blog_description'],0,200))."..." ?></p>
